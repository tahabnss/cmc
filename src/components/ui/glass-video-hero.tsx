    ...
    <>
      ...
      >
        <button
          ...
          className="absolute top-20 right-4 z-20 p-2.5 rounded-[10px] backdrop-blur-xl border border-accent/30 bg-background/40 text-foreground hover:bg-accent/10 transition-all focus:outline-none cursor-pointer"
        >
        ...
        <div className="relative z-10 flex flex-col items-center text-center justify-center min-h-screen px-6">
          <h1 className="font-bold text-foreground text-5xl lg:text-[96px] leading-[1.05] tracking-[-0.02em] max-w-5xl">
            Carreaux
            <br />
